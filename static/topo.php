        ...
        <ul class="navbar-nav navbar-align">
                        ...
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="text-muted small mt-1">30 minutos atrás</div>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="text-muted small mt-1">2 horas atrás</div>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-10">
                                    <div class="text-dark">Login de 192.186.1.8</div>
                                    <div class="text-muted small mt-1">5 horas atrás</div>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="text-muted small mt-1">Christina aceitou sua solicitação.</div>
                        ...
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-10 ps-2">
                                    ...
                                    <div class="text-muted small mt-1">15 minutos atrás</div>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="list-group-item">
                        ...
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-10 ps-2">
                                    ...
                                    <div class="text-muted small mt-1">4 horas atrás</div>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="list-group-item">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                    <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Fabio Brasileiro</span>
                </a>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="../Fintech/Pages/index.html">Sair</a>
                </div>
            </li>
        </ul>
    </div>
